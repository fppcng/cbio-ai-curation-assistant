...
Run workspace discovery and use `workspace.curated` as the mutation-curation workspace for the study.
Do not infer this path from repository layout.

Within `workspace.curated`:
