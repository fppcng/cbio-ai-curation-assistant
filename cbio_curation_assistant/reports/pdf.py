...
def build_curation_report_pdf(meta: dict[str, Any], summary: dict[str, Any]) -> bytes:
    ...
    def footer(canvas, doc_obj) -> None:
        ...
        canvas.drawRightString(
            doc_obj.pagesize[0] - 12 * mm, 7 * mm, f"Page {canvas.getPageNumber()}"
        )
        canvas.restoreState()
            ...
            style_commands.extend(
                [
                    (
                        ...
                        (3, row_index),
                        (3, row_index),
                        colors.HexColor(confidence_bg),
                    ),
                    (
                        "TEXTCOLOR",
                        (3, row_index),
                        (3, row_index),
                        colors.HexColor(confidence_text),
                    ),
                    ...
                    (
                        ...
                        (4, row_index),
                        (4, row_index),
                        colors.HexColor(curability_bg),
                    ),
                    (
                        "TEXTCOLOR",
                        (4, row_index),
                        (4, row_index),
                        colors.HexColor(curability_text),
                    ),
                    ...
                    (
                        ...
                        (5, row_index),
                        (5, row_index),
                        colors.HexColor(priority_bg),
                    ),
                    (
                        "TEXTCOLOR",
                        (5, row_index),
                        (5, row_index),
                        colors.HexColor(priority_text),
                    ),
    ...
    if breakdown:
        for row in breakdown:
            ...
            detail_rows = [
                ...
                [
                    p("Priority", "BodySmall"),
                    p(row.get("priority") or "—", "BodySmall"),
                ],
                [
            ...
            confidence_text, confidence_bg = _confidence_palette(
...
def build_curation_report_filename(
    meta: dict[str, Any], summary: dict[str, Any]
) -> str:
    raw_name = (
